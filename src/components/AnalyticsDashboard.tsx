...
export const AnalyticsDashboard: React.FC<AnalyticsDashboardProps> = ({ logs, escalations }) => {
  ...
  return (
    <motion.div 
      ...
      className="space-y-6"
    >
      <div className="flex justify-between items-end bg-white p-4 sm:p-6 rounded-2xl shadow-sm border border-gray-100">
        <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <motion.div variants={itemVariants} className="bg-white p-4 sm:p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-4 relative overflow-hidden group">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <motion.div variants={itemVariants} className="bg-white p-4 sm:p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col">
        ...
        <motion.div variants={itemVariants} className="lg:col-span-3 bg-white p-4 sm:p-6 rounded-2xl shadow-sm border border-gray-100">
